...
const Color corPrimaria = Color(0xFF40C0B5); // Verde-Água (Mantido para identidade)
const Color corSecundaria = Color(0xFFFF7F50); // Coral Suave (Mantido para destaque)
const Color corAcao = Color(0xFF2A9D8F); // Verde Intenso (Mantido para Call to Action)
const Color corFundo = Color(0xFF1A1A1A); // Cinza Escuro (Fundo)
const Color corSuperficie = Color(0xFF2C2C2C); // Cinza Médio (Superfícies como Cards)
const Color corTexto = Color(0xFFE0E0E0); // Cinza Claro (Texto)
...
ThemeData darkTheme() {
  return ThemeData(
    ...
    // 3. Tema para a AppBar
    appBarTheme: const AppBarTheme(
      backgroundColor: corSuperficie, // AppBar com cor de superfície
      foregroundColor: corTexto, // Cor do título e dos ícones na AppBar
